			...
			<main className="overflow-hidden">
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						An Airbnb clone web application built with the MERN stack (MongoDB, Express.js, React.js, Node.js) and styled using Tailwind CSS and Shadcn. Users can search accommodations, view details, make bookings, and manage their listings. The application includes secure authentication using JWT and supports Google login via Google Cloud. Cloudinary handles image storage and delivery, ensuring efficient management. The design is responsive, providing a seamless experience across devices. You can see the source code of this project on my GitHub or preview the project by clicking the button below.
						</p>{" "}
						<div className="mt-3">
							...
							<Button variation="secondary">
								<a
									href="https://ease-nest.netlify.app/"
									target="_blank"
