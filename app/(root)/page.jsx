							...
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									<motion.p
										...
										A Software Engineer currently focused on Web Development, with additional interests in Machine Learning, Mobile Development, and Problem Solving. I am eager to learn new things and always open to new opportunities.
									</motion.p>
									<motion.div
										...
										<Button variation="primary">
											<Link
												href={"/docs/AnshulYadavResume.pdf"}
												target="_blank"
							...
							<div className="relative md:h-screen w-screen gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
									...
									<motion.p
										...
										These are some of my projects that I have
										done{" "}
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<motion.p
										...
										<a href="mailto:anshul.yadv22@gmail.com?subject=Hello&body=Hello Anshul,">
									...
									<div className="flex justify-center items-center space-x-4">
										<motion.a
											href="mailto:anshul.yadv22@gmail.com?subject=Hello&body=Hello Anshul,"
										...
										<motion.a
											href="https://www.linkedin.com/in/anshul-yadav-a10b31136/"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
										...
										<motion.a
											href="https://x.com/Anshul__Yadav_"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
										...
										<motion.a
											href="HTTPS://discordapp.com/users/893793715771039796"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
